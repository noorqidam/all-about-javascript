...
function startDiceGame(playerCount, diceCount) {
  ...
  playerList.forEach((player, index) => {
    // console.log(`player #${index + 1} score: ${player.point}`);
  ...
  console.log(`\nThe winner is player #${winner} with ${highestScore} points.`);
  console.log(`Game ended because only player #${winner} has dice`);
}
